...
public class VoteController {
	...
	@PutMapping(value="second/{cgmixno}", 
			consumes="application/json", 
			produces = MediaType.TEXT_PLAIN_VALUE)
		public ResponseEntity<String> modifyA(@PathVariable("cgmixno") int cgmixno){
		
		ResponseEntity<String> entity = null;
		
		try {
			service.upcountA(cgmixno);
			entity = 
					new ResponseEntity<String>(
							"SUCCESS", HttpStatus.OK);
		} catch (Exception e) {
	...
	@PutMapping(value="third/{cgmixno}", 
			consumes="application/json", 
			produces = MediaType.TEXT_PLAIN_VALUE)
		public ResponseEntity<String> modifyB(@PathVariable("cgmixno") int cgmixno){
		
		ResponseEntity<String> entity = null;
		
		try {
			service.upcountB(cgmixno);
			entity = 
					new ResponseEntity<String>(
							"SUCCESS", HttpStatus.OK);
		} catch (Exception e) {
